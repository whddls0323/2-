...
class Summer1 extends JFrame {
    JFrame frame;
    JPanel panel;

    public Summer1() {
        frame = new JFrame("Summer clothes1");
        ...
        try {
            ...
            ResultSet resultSet = statement.executeQuery("SELECT name, brand, price, size, inventory FROM summer WHERE id = 1");
