...
class Winter1 extends JFrame {
    JFrame frame;
    JPanel panel;

    public Winter1() {
        frame = new JFrame("Winter clothes1");
        ...
        try {
            ...
            ResultSet resultSet = statement.executeQuery("SELECT name, brand, price, size, inventory FROM winter WHERE id = 1");
