...
class Autumn1 extends JFrame {
    JFrame frame;
    JPanel panel;

    public Autumn1() {
        frame = new JFrame("Autumn clothes1");
        ...
        try {
            ...
            ResultSet resultSet = statement.executeQuery("SELECT name, brand, price, size, inventory FROM autumn WHERE id = 1");
