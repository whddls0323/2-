...
class Summer7 extends JFrame {
    JFrame frame;
    JPanel panel;

    public Summer7() {
        frame = new JFrame("Summer clothes7");
        frame.setSize(1000, 700);
        setDefaultCloseOperation(JFrame.DISPOSE_ON_CLOSE);
        panel = new JPanel();

        // 이미지 파일의 경로 설정 (각 버튼에 맞게 설정하세요)
        String imagePath1 = "summer7.png";
        ...
        try {
            ...
            ResultSet resultSet = statement.executeQuery("SELECT name, brand, price, size, inventory FROM summer WHERE id = 7");
