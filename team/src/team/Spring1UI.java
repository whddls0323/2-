...
class Spring1 extends JFrame {
    JFrame frame;
    JPanel panel;

    public Spring1() {
        frame = new JFrame("Spring clothes1");
        ...
        try {
            ...
            ResultSet resultSet = statement.executeQuery("SELECT name, brand, price, size, inventory FROM spring WHERE id = 1");
