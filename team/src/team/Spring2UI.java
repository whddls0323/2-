...
class Spring2 extends JFrame {
    JFrame frame;
    JPanel panel;

    public Spring2() {
        frame = new JFrame("Spring clothes2");
        frame.setSize(1000, 700);
        setDefaultCloseOperation(JFrame.DISPOSE_ON_CLOSE);
        panel = new JPanel();

        // 이미지 파일의 경로 설정 (각 버튼에 맞게 설정하세요)
        String imagePath1 = "spring2.png";
        ...
        try {
            ...
            ResultSet resultSet = statement.executeQuery("SELECT name, brand, price, size, inventory FROM spring WHERE id = 2");
