...
class Autumn4 extends JFrame {
    JFrame frame;
    JPanel panel;

    public Autumn4() {
        frame = new JFrame("Autumn clothes4");
        frame.setSize(1000, 700);
        setDefaultCloseOperation(JFrame.DISPOSE_ON_CLOSE);
        panel = new JPanel();

        // 이미지 파일의 경로 설정 (각 버튼에 맞게 설정하세요)
        String imagePath1 = "autumn4.png";
        ...
        try {
            ...
            ResultSet resultSet = statement.executeQuery("SELECT name, brand, price, size, inventory FROM autumn WHERE id = 4");
